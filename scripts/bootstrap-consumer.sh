...
# (a) pre-merge-review.yml (소비자 측, 5-10줄 reusable 호출)
GATE_CONTENT=$(cat <<EOF
# Auto-generated by changeguard bootstrap-consumer.sh
# 정책 본부: https://github.com/$POLICY_REPO
# 갱신: changeguard에 새 commit이 생기면 policy-bump-watcher.yml 이 매주 갱신 PR을 제안합니다.
...
# (b) policy-bump-watcher.yml (소비자 측, 5-10줄)
